...
$(document).ready(function()
{
     ...
     * eles estão aqui apenas para evitar que cliques em botões
     * o tirem de seu lugar na página.
     */
    ...
    $(".copy-code").focus(function ()
    {
        ...
        /**
         * Push select para loop de eventos para chrome.
         */
        setTimeout(function ()
        {
            $(el).select();
