...
(function()
{
    ...
    {
        /**
         * Se o contexto for um objeto de namespace, retorne
         * um novo objeto.
         */
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        clone: function(events)
        {
            ...
            /**
             * É necessário definir o expando como null no conjunto clonado,
             * se existir, removeData não funciona aqui, o IE também o remove
             * do original, isso é principalmente para o IE, mas o expando de
             * dados não deve ser copiado em nenhum navegador.
             */
        ...
        add: function(t)
        {
            return this.pushStack(
                jQuery.merge(
                    this.get(),
                    t.constructor == String ? jQuery(t).get() : t.length != undefined && (!t.nodeName || jQuery.nodeName(t, "form")) ? t : [t]
                )
            );
        },
    ...
    jQuery.extend({
        ...
        data: function(elem, name, data)
        {
            ...
            /**
             * Evite substituir o cache nomeado por valores indefinidos.
             */
            if (data != undefined)
            {
        ...
        removeData: function(elem, name)
        {
            ...
            /**
             * Se quisermos remover uma seção específica dos dados
             * do elemento.
             */
            if (name)
            {
                if (jQuery.cache[id])
                {
                    ...
                    /**
                     * Se removemos todos os dados, remova o cache do elemento.
                     */
                    name = "";
        ...
        curCSS: function(elem, prop, force)
        {
            ...
            } else if (document.defaultView && document.defaultView.getComputedStyle)
            {
                ...
                } else
                {
                     ...
                     * melhor se soubéssemos o tipo exato de exibição que
                     * eles possuem).
                     */
        ...
        clean: function(a, doc)
        {
            ...
            jQuery.each( a, function(i, arg)
            {
                ...
                if (typeof arg == "string")
                {
                    ...
                    {
                        /**
                         * String era uma <table>, *pode* ter <tbody> espúrio.
                         */
    ...
    jQuery.extend({
        ...
        ready: function()
        {
            ...
            if (!jQuery.isReady)
            {
                ...
                {
                    /**
                     * Não remova se houver frames (#1187).
                     */
    ...
    jQuery.extend({
        ...
        ajax: function(s)
        {
            ...
            /**
             * Conversor de dados ainda não é para uma string.
             */
             ...
             * tentando carregar JSON ou Script.
             */
            ...
            /**
             * Permitir headers/mimetypes personalizados.
             */
            if (s.beforeSend)
            {
                s.beforeSend(xml);
    ...
    jQuery.fx.prototype = {
        ...
        update: function()
        {
            ...
            /**
             * Defina a propriedade de exibição para bloquear animações
             * de altura/largura.
             */
    ...
    /**
     * O método Offset, parte do plugin Dimension.
        ...
        if (elem)
        {
            with (jQuery.browser)
            {
                ...
                if (elem.getBoundingClientRect)
                {
                    ...
                    /**
                     * O IE adiciona a borda do elemento HTML, por padrão é
                     * média que tem 2px. Modo peculiar do IE 6 e IE 7, a
                     * largura da borda pode ser substituída pelo seguinte
                ...
                } else
                {
                    ...
                    {
                        /**
                         * Adicionar offsetParent offsets.
                         */
                        add(
                        ...
                        /**
                         * Mozilla e Safari > 2 não incluem a borda dos parents
                         * offset. No entanto, a Mozilla adiciona a borda para
                        ...
                        /**
                         * Safari <= 2 duplica os deslocamentos do corpo
                         * com um elemento ou pai absolutamente posicionado.
                         */
                    ...
                    while (parent.tagName && !/^body|html$/i.test(parent.tagName))
                    {
                        ...
                        {
                            /**
                             * Subtraia os offsets de rolagem pai.
                             */
                            add(
                                -parent.scrollLeft,
                                -parent.scrollTop
                    ...
                    /**
                     * O Safari duplica os deslocamentos do corpo com um
                     * elemento ou pai absolutamente posicionado.
                     */
                    if (safari2 && absolute)
                    {
                        add(
